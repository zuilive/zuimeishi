...
$(op.container).animate({left:cleft-5,width:cwidth},50,function(){
...
thead.wrap("<div class='gridHeader'><div class='gridThead'><table style='width:"+(tlength)+"px;'></table></div></div>");
...
var glayoutH=layoutH-(-29);
var layoutStr=glayoutH?" layoutH='"+glayoutH+"'":"";
...
var data=eval("("+data+")");
$('#photo').attr("src",data.savepath);
$('#thumbnails').val(data.thumb);}
